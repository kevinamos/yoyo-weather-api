...
SECRET_KEY = 'django-insecure-^6xgg2fd2w2ue*4zc6&=wx00q=h0)d@n#^row@g8pfmztkm632'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'weather_calculator.apps.WeatherCalculatorConfig',
]
...
WEATHER_API_KEY =  os.environ['weatherapi_api_key']


# HOSTNAME: str = os.environ.get("HOSTNAME", "")
# PORT = os.environ.get("DJANGO_PORT", "80")

# if PORT not in ["80", "43", "8000"]:
